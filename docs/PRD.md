...
> This is the original requirements document, written for the local-model version in May 2026. It still names Deutsche Bank and the Ollama categoriser, which the hosted build replaced with Claude Haiku and 4 banks. The [README](../README.md) describes the current build.
