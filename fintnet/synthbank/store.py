...
from fintnet.models import (Account, BankConnection, SbAccount, SbCustomer, SbLabel, SbTransaction, Transaction, db)
...
def reset_demo() -> dict:
    ...
    from fintnet.models import DismissedAlert, User
...
def sync_all_connections(sync_fn) -> dict:
    ...
    from fintnet.synthbank import client as synthbank_client

    from fintnet.models import User
